...
def main():
    ...
    p.add_argument("-n","--nodes",
                   default="node1,node2,node3,node4,node5,node6,node7,node8,node9,node10,node11,node16")
    ...
    for feat, count in alloc.items():
        ...
        # 3) distribute into bins, capturing both names & sum_secs
        ...
        for names, sum_secs in bins:
            ...
            entry = {
                ...
                "SEND_TO": email_list,
                # new fields from feature-config (with global defaults)
