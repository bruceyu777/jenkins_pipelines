...
def call() {
    // Load shared parameters and common configuration.
    ...
    pipeline {
        ...
        stages {
            stage('Set Build Display Name') {
                steps {
                    script {
                        // Set the build display name using NODE_NAME, BUILD_NUMBER, FEATURE_NAME, and TEST_GROUP_CHOICE.
        ...
        post {
            always {
                script {
                    ...
                    // Compute the archive group from the legacy test group choice.
                    ...
                    if (archivedFolders.isEmpty()) {
                        ...
                        publishHTML(target: [
                            reportDir: ".",
                            reportFiles: "summary_${archiveGroup}.html",
                            reportName: "Test Results Summary for ${archiveGroup}"
                        ])
                    }
                }
