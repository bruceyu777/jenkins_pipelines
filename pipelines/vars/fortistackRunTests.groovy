            ...
            withCredentials([usernamePassword(credentialsId: 'LDAP', usernameVariable: 'SVN_USER', passwordVariable: 'SVN_PASS')]) {
              ...
              for (group in computedTestGroups) {
                  ...
                  sh """
                      ...
                      python3 autotest.py -e testcase/${SVN_BRANCH}/${params.FEATURE_NAME}/${params.TEST_CONFIG_CHOICE} -g testcase/${SVN_BRANCH}/${params.FEATURE_NAME}/${group} -d -s ${params.ORIOLE_SUBMIT_FLAG}
                  """
              }
