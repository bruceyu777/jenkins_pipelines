        ...
        stage('Archive Test Results') {
            steps {
                script {
                    ...
                    // Determine test groups from TEST_GROUPS if provided; support both JSON array and comma-separated string.
                    def testGroups = []
                    ...
                    for (group in testGroups) {
                        ...
                        if (!folder) {
                            ...
                            // Create a subfolder for this group in the workspace and copy its results.
                    ...
                    if (archivedFolders.isEmpty()) {
                        ...
                        // Archive only the current build's results.
                        archiveArtifacts artifacts: "test_results/**, summary_*.html", fingerprint: false
                        // Optionally, publish the summary for the first test group.
                        publishHTML(target: [
                            reportDir: ".",
