            ...
            steps {
                script {
                    ...
                    sh """
                      ...
                      docker compose -f /home/fosqa/testcase/${branch}/${feature}/docker/docker.avfortisandbox_avfortisandbox.yml  down
                      docker compose -f /home/fosqa/testcase/${branch}/${feature}/docker/docker.avfortisandbox_avfortisandbox.yml  up -d
