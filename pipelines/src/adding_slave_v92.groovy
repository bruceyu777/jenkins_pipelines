        ...
        stage('Install Jenkins Agent on Node') {
            steps {
                script {
                    ...
                    // First, perform a remote git pull to update tools.
                    try {
                        def gitPullCmd = "sshpass -p '${params.NODE_PASSWORD}' ssh -o StrictHostKeyChecking=no ${params.NODE_USER}@${params.NODE_IP} 'cd /home/fosqa/resources/tools && git pull'"
...
"""
                    ...
                    // Use sshpass to run the remote install command.
