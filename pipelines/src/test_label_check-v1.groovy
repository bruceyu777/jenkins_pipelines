...
pipeline {
    ...
    stages {
        ...
        // New Stage to Trigger Downstream Pipeline Collect_Runtime_Hash
                ...
                script {
                    try {
                        ...
                        def downstreamBuild = build job: downstreamJob,
                            ...
                            wait: true,
                            propagate: false // If true, will fail the master build if downstream fails

                        echo "Downstream pipeline '${downstreamJob}' triggered successfully with Build Number: ${downstreamBuild.number}"
                    } catch (err) {
