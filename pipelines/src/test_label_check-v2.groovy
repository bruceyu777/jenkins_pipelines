...
pipeline {
    ...
    stages {
        ...
        // Stage to Trigger Downstream Pipeline
        stage('Trigger Downstream Pipeline') {
            // Execute this stage only if Trigger_Collect_Runtime_Hash is true
            when {
            ...
            steps {
                script {
                    try {
                        ...
                        // Update the master build's description with downstream build details
